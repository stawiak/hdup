...
case class MeasurementReadRequest(tableName: String, customer: String, location: String, wireid: String, periods: Array[Interval]) {
...
case class InterpolatedReadRequest(customer: String, location: String, wireid: String, periods: Array[Interval]) {
